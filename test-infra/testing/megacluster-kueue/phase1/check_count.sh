...
# Pods for Small Burst Workload
get_pod_counts "$TARGET_NAMESPACE" "group=small-batch-workload-burst" "Small Burst Workload Pods (group=small-batch-workload-burst)"

# Pods for Medium Burst Workload
get_pod_counts "$TARGET_NAMESPACE" "group=medium-batch-workload-burst" "Medium Burst Workload Pods (group=medium-batch-workload-burst)"

# Pods for Large Burst Workload
get_pod_counts "$TARGET_NAMESPACE" "group=large-batch-workload-burst" "Large Burst Workload Pods (group=large-batch-workload-burst)"

# Pods for All Batch Workloads (by type)
